...
class soap_getOutageDetails {
	
	//Logging implementation
	public static Logger log = LogManager.getLogger(soap_getOutageDetails.class.getName());
	...
	public void testJSONExtractRestAssured(String s1) throws IOException{
		...
		Response res=
				...
				.when()
				.get(prop.getProperty("SOAPURI"))
				
				
		.then ()
		//.assertThat().statusCode(201);   //To fail the script
		//.assertThat().statusCode(500).body(prop.getProperty("JSONFaultPath"), is(prop.getProperty("JSONFaultCode")))
